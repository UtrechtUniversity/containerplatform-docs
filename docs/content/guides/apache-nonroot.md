...
```bash
$ sudo docker push DOCKER-USER/custom-httpd:v1
...
```bash
$ sudo docker build -t DOCKER-USER/custom-httpd:v2 -f Dockerfile-v2 .
...
```bash
$ sudo docker push DOCKER-USER/custom-httpd:v2
...
```bash
$ sudo docker build -t DOCKER-USER/custom-httpd:v3 -f Dockerfile-v3 .
...
```bash
$ sudo docker push DOCKER-USER/custom-httpd:v3
...
```
Now the image runs as non root on OpenShift 
